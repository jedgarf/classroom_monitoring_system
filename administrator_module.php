...
<div id="search">
	<form target="view" method="GET" action="search.php" autocomplete="off">
		<label>QUICK SEARCH FOR STUDENT ATTENDANCE</label><br><br>
		<label style="size: 25px;">Search By ID: <b>GC </b></label><input pattern="[0-9]{2}-[0-9]{3}" type="text" name="s" maxlength="6" class="lfield" style="width: 120px; height: 25px;"  placeholder="Student ID" required="" autofocus> - <select name="hati" class="lfield" style="width: 120px; height: 25px;">
			<option>Today</option>
...
<div id="info">
	...
	require 'dbcon.php';
		...
		$age = $diff->format('%y');
				...
				echo "<big>Name:".$row['Acc_Fname']." ".$row['Acc_Lname']."</big><br><br>";
...
<ul>
    ...
    <a href="add_classroom.php" target="view">Add/View All Classroom</a>
	...
	<a href="add_professor.php" target="view" style="color: white;">
	<div class="dropdown">
	<li class="dropbtn">PROFESSORS</li>
	</div></a>
	<div class="dropdown">
	<li class="dropbtn">ACCOUNTS
  	<div class="dropdown-content">
    <a href="admin_edit.php" target="view">Change Profile</a>
    <a href="manual_back-up.php" onclick="return confirm('Your back-up will be located in drive D.')">Back-Up the Database</a>
